...
require (
	github.com/MixinNetwork/bot-api-go-client v1.9.0
...
require (
	...
	github.com/MixinNetwork/bot-api-go-client/v2 v2.0.2 // indirect
	github.com/MixinNetwork/mixin v0.17.6 // indirect
